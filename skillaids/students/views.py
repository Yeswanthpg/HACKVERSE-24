    ...
    if request.method == 'POST':
        if 'signin' in request.POST:
            ...
            if user is not None:
                ...
                return render(request, 'signup.html', {'signin_error_message': error_message})
            ...
            if (User.objects.filter(username=email).exists() or 
                ...
                return render(request, 'signup.html', {'signup_error_message': 'User Already Exists'})
            
            if password != confirm_password:
                return render(request, 'signup.html', {'signup_error_message': 'Password did not match'})
